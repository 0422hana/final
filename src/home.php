...
<?php
    ...
    echo '<table border="1">';
    echo '<tr><td width="230" height="30">SHOP</td> <td width="230" height="30">FOOD</td> <td width="100" height="30">CATEGORY</td> <td width="100" height="30">PRICE</td> <td width="290" height="30">ADDRESS</td> <td width="30" height="30"></td><td width="30" height="30"></td></tr>';
