...
<?php
    ...
    echo '<table border="1">';
    echo '<tr><td width="200" height="30">SHOP</td> <td width="200" height="30">FOOD</td> <td width="110" height="30">CATEGORY</td> <td width="110" height="30">PRICE</td> <td width="250" height="30">ADDRESS</td> <td width="80" height="30"></td></tr>';
